...
public:
    ...
    void setupUi(QMainWindow *Camera)
    {
        ...
        gridLayout_3->addWidget(stackedWidget, 1, 0, 3, 1);
        ...
        gridLayout_3->addWidget(tabWidget, 0, 0, 1, 2);
    ...
    void retranslateUi(QMainWindow *Camera)
    {
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("Camera", "Tab 1", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_4), QApplication::translate("Camera", "Tab 2", nullptr));
